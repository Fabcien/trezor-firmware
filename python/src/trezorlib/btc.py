...
from .tools import expect, normalize_nfc, normalize_raw, session
...
def sign_message(
    ...
    message = normalize_nfc(message) if signing_algo == messages.SigningAlgo.ECDSA else normalize_raw(message)
    return client.call(
